	...
	<div class="container col-sm-10 bg-white text-color-grey">
			...
			<div class="col-xs-12">
				...
				<div class="col-xs-12 col-sm-4">
					<address>
						<h1><div class="h4 text-color-grey">Campusradio Jena</div></h1>
				...
				<div class="col-xs-12 col-sm-4">
					<address>
						<h1><div class="h4 text-color-grey">CampusTV Jena</div></h1>
						<ul class="list-unstyled h5">
							<li><div class="note">Ernst-Abbe-Hochschule Jena</div></li>
				...
				<div class="col-xs-12 col-sm-4">
					<address>
						<h1><div class="h4 text-color-grey">Akrützel</div></h1>
						<ul class="list-unstyled h5">
